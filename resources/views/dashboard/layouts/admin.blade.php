...
<html>
<head>
    @include('dashboard.partials.admin_head')
</head>
<body class="">
      ...
      $(document).ready(function() {
        $().ready(function() {
          ...
          $('.fixed-plugin .background-color span').click(function() {
            ...
            console.log("fixed-plugin .background-color es: " + $(this).data('color'));
          ...
          $('.switch-change-color input').on("switchChange.bootstrapSwitch", function() {
            console.log("switch change color input");
            var $btn = $(this);
